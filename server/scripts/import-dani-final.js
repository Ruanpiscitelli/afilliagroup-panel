...
async function main() {
    ...
    console.log('=== Limpando métricas antigas da Dani ===');
    ...
    const csvData = [
        {
            ...
            registrations: 36,
            ftds: 4,
            qualifiedCpa: -119,  // Arredondando de -118.73
        ...
        },
        {
            ...
            registrations: 30,
            ftds: 5,
            qualifiedCpa: 41,   // Arredondando de 41.15
        ...
        },
        {
            ...
            registrations: 7,
            ftds: 0,
            qualifiedCpa: 18,   // Arredondando de 18.25
            depositAmount: 47.00,
            commissionCpa: 0.00,
            commissionRev: 23.50,
        },
    ...
    console.log('\n✅ Dani atualizada com datas corretas!');
}
